...
export function reviewjoinList(query) {
  return request({
    url: '/company/review/tg/joinList',
    method: 'get',
    params: query
  })
}
...
export function getCode(query) {
  return request({
    url: '/company/review/tg/getSelfCode',
    method: 'get',
    params: query
  })
}
...
export function getByCode(query) {
  return request({
    url: '/company/review/tg/getByCode',
    method: 'get',
    params: query
  })
}
