              ...
              <el-col :span="24">
                <el-form-item label="普票服务费" prop="ordinaryProxyFee">
                  ...
                  <div>
                    ...
                    <el-input disabled v-else type="number" style="width:100%" v-model="ruleForm.ordinaryProxyFee"
...
export default {
  ...
  mounted() {
      let item=this.$cache.local.getJSON("tg-placeDetailItem");
      let  res=this.$cache.local.getJSON("tg-placeDetailItems");
