    ...
    >
      ...
      <el-row type="flex" class="row-bg" justify="space-around">
        ...
        <el-col :span="9">
          ...
          <el-form-item label="复核" class="comright">
            <el-input v-model="formData.checkUser" :readonly="true"></el-input>
          </el-form-item>
      ...
      <el-row type="flex" class="row-bg" justify="space-around">
        <el-col :span="21">
          ...
          >
            <el-radio :disabled="true" v-model="isokradioS" label="1">
              通过</el-radio
            >
          </el-form-item>
        </el-col>
        ...
        <el-col :span="21">
          ...
          >
            <div
              ...
              "
            >
              <el-radio :disabled="true" v-model="isokradioS" label="2"
                >不通过
              </el-radio>
              <el-input
                type="textarea"
...
import { getTicketDetail } from "@/api/tg-api/project/ticket";
