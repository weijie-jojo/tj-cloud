...
import { list, del, checkdetail, getCount } from "@/api/tg-api/project/list";
...
export default {
  ...
  methods: {
            ...
            this.$confirm("", {
              ...
              .then(() => {
                if (this.msgs == "查看") {
                  ...
                  this.$tab.openPage(
                    "收款列表",
                    "/tg-business/project/aduitCollectList"
                  );
    ...
    addList() {
      ...
      switch (this.types) {
        case 2:
          ...
          break;
        case 4:
          this.$tab.closeOpenPage({ path: "/tg-business/project/addMeans" });
          break;
        case 5:
          this.$tab.closeOpenPage({ path: "/tg-business/project/addDutypaid" });
          break;
      }
    },
    //审核
    aduit() {
      ...
      switch (this.types) {
        case 1:
          ...
          break;
        case 4:
          this.$tab.closeOpenPage({ path: "/tg-business/project/aduitMeans" });
          break;
        case 5:
          this.$tab.closeOpenPage({ path: "/tg-business/project/aduitDutypaid" });
          break;
      }
    },
    //修改
    editList() {
      ...
      switch (this.types) {
        ...
        case 2:
          ...
          break;
        case 4:
          this.$tab.closeOpenPage({ path: "/tg-business/project/meansEdit" });
          break;
        case 5:
          this.$tab.closeOpenPage({ path: "/tg-business/project/dutypaidsEdit" });
          break;
        case 6:
    ...
    findList() {
      ...
      this.$cache.local.setJSON('tg-backMean',obj);
      this.$cache.local.setJSON("tg-backTicket", obj);
      ...
      switch (this.types) {
        case 1:
          ...
          break;
        case 2:
          this.$tab.openPage("票据列表查看", "/tg-business/project/ticketlist");
          break;
        case 4:
          this.$tab.openPage("资料审核查看", "/tg-business/project/auditMeansDetail");
          break;
        case 5:
          this.$tab.openPage(
            "完税审核查看",
            "/tg-business/project/aduitDutypaidDetail"
          );
          break;
        case 6:
          this.$tab.openPage("出款列表查看", "/tg-business/project/aduitCollectList");
          break;
        case 7:
          this.$tab.openPage("收款列表查看", "/tg-business/project/aduitDisburseList");
          break;
      }
    },
    //获取对应日志分页数据
    ...
    /** 新增按钮操作 */
    handleAdd() {
      this.$tab.openPage("项目新增", "/tg-business/project/add");
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
