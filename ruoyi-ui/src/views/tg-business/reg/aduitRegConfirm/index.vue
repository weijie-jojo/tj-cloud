    ...
    >
      ...
      <el-row type="flex" class="row-bg rowCss" justify="space-around">
        ...
        <el-col :span="9">
          <el-form-item class="comright" label="城市" prop="city">
            <el-input v-model="formData.city" :readonly="true"> </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex" class="row-bg rowCss" justify="space-around">
        <el-col :span="9">
          <el-form-item class="comright" label="区（县）" prop="county">
            <el-input v-model="formData.county" :readonly="true"> </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9">
          <el-form-item
      ...
      <el-row type="flex" class="row-bg rowCss" justify="space-around">
        ...
        <el-col :span="9">
          <el-form-item class="comright" label="行业税率">
            <el-input v-model="industryTax" :readonly="true"> </el-input>
          </el-form-item>
        </el-col>
      </el-row>
        ...
        >
          <el-col :span="9">
            <el-form-item
              ...
              :required="true"
            >
              <el-radio disabled v-model="formData.isPublicUser" label="0"
                >开启</el-radio
              >
              <el-radio disabled v-model="formData.isPublicUser" label="1"
                >关闭</el-radio
              >
            </el-form-item>
          </el-col>
        ...
        <div v-if="formData.isPublicUser == 0">
          ...
          >
            <el-col :span="9">
              ...
              <el-form-item class="comright" label="开户银行">
                <el-input
                  v-model="formData.publicDepositBank2"
                  :readonly="true"
                ></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="9">
              ...
              <el-form-item class="comright" label="银行账号">
                <el-input
                  v-model="formData.publicAccountNumber2"
                  :readonly="true"
                ></el-input>
              </el-form-item>
            </el-col>
      ...
      <el-row type="flex" class="row-bg" justify="space-around">
        <el-col :span="9">
          ...
          <el-form-item label="纳税委托协议" prop="fileName3">
            <uploadSmall
              v-if="fileNameN3.length > 0"
              @getfileName="getfileNameS"
              :fileName="isNone"
              :fileNameOld="fileNameN3"
              :isDetail="isDetail"
            ></uploadSmall>
          </el-form-item>
          <el-form-item label="三方协议签约凭证" prop="fileName4">
            <uploadSmall
              v-if="fileNameN4.length > 0"
              @getfileName="getfileNameS"
              :fileName="isNone"
              :fileNameOld="fileNameN4"
              :isDetail="isDetail"
            ></uploadSmall>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="9">
          ...
          <div v-if="formData.isSliderOrdinary == 0">
            ...
            <el-form-item label="服务费含税" :required="true">
              <el-radio :disabled="true" v-model="formData.isSelfTax" label="0"
                >是</el-radio
              >
              <el-radio :disabled="true" v-model="formData.isSelfTax" label="1"
                >否</el-radio
              >
            </el-form-item>
            <el-form-item label="价税分离" :required="true">
              <el-radio
                :disabled="true"
                v-model="formData.isOrdinaryTax"
                label="0"
                >是</el-radio
              >
              <el-radio
            ...
            <el-form-item label="是否分润" :required="true">
              <el-radio
                :disabled="true"
                v-model="formData.isOrdinaryShare"
                label="0"
                >是</el-radio
              >
              <el-radio
            ...
            <el-form-item v-if="formData.isOrdinaryShare == 0" :required="true">
              <div style="">
                ...
                <el-input
                  ...
                  style="margin-right: 10px; width: 87%"
                  :step="0.01"
                  :min="0"
                  oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'
                >
      ...
      <el-row type="flex" class="row-bg" justify="space-around" v-if="formData.isSelfCount==0">
        ...
        <el-option v-for="item in optionz" :key="item.value" :label="item.label" :value="item.value">
            ...
            <el-form-item label="服务费含税" :required="true">
              <el-radio
                :disabled="true"
                v-model="formData.isSpecialSelfTax"
                label="0"
                >是</el-radio
              >
              <el-radio
            ...
            <el-form-item label="是否分润" :required="true">
              <el-radio
                :disabled="true"
                v-model="formData.isSpecialShare"
                label="0"
                >是</el-radio
              >
              <el-radio
      ...
      <el-row type="flex" class="row-bg" justify="space-around">
        <el-col :span="21">
          <el-form-item
            class="comright"
            style="padding-right: 4.2%; margin-left: -5%"
          >
      ...
      <el-row type="flex" class="row-bg" justify="space-around">
        ...
        <el-col :span="8" class="flexs">
          ...
          <el-button
            ...
            >提交</el-button
          >
          <el-button v-else type="primary" @click="submitForm3(1)"
            >提交</el-button
          >
        </el-col>
        <el-col :span="8"></el-col>
...
export default {
  ...
  mounted() {
    ...
    this.fileName1 = JSON.parse(
      this.$cache.local.getJSON("tg-infolist").fileName1
    );
    ...
    this.fileName2 = JSON.parse(
      this.$cache.local.getJSON("tg-infolist").fileName2
    );
    ...
    this.fileName3 = JSON.parse(
      this.$cache.local.getJSON("tg-infolist").fileName3
    );
    ...
    this.fileName4 = JSON.parse(
      this.$cache.local.getJSON("tg-infolist").fileName4
    );
    ...
    this.fileName5 = JSON.parse(
      this.$cache.local.getJSON("tg-infolist").fileName5
    );
    ...
    this.fileName6 = JSON.parse(
      this.$cache.local.getJSON("tg-infolist").fileName6
    );
    ...
    this.fileName7 = JSON.parse(
      this.$cache.local.getJSON("tg-infolist").fileName7
    );
  ...
  methods: {
    ...
    resetForm() {
      this.$tab
        .closeOpenPage({
          path: this.$cache.local.getJSON("tg-resultBack").backUrl,
        })
        .then(() => {
          this.$tab.refreshPage({
            path: this.$cache.local.getJSON("tg-resultBack").backUrl,
            name: this.$cache.local.getJSON("tg-resultBack").backName,
          });
        });
    },
    nailist() {
