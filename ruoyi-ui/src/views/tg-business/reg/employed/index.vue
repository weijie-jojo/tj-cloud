...
import { joinList, getCount, delEmployed, checkdetail } from "@/api/tg-api/company/employed";
...
export default {
  ...
  methods: {
   ...
   check(self_code, self_type) {
    ...
    /** 新增按钮操作 */
    handleAdd() {
      this.$tab.refreshPage({path:"/tg-business/reg/addEmployedInfo",name:'AddEmployedInfo'});
    },
    /** 删除按钮操作 */
    handleDelete() {
