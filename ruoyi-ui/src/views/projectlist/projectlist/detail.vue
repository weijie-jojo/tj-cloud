        ...
        <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="140px">
            ...
            <el-row type="flex" class="row-bg " justify="space-around">
                <el-col :span="9">
                    <el-form-item class="comright" label="名称" prop="purchCompany">
                        <el-input :readonly="true" v-model="formData.purchCompany"></el-input>
                    </el-form-item>
                    <el-form-item class="comright" label="地址">
                        <el-input  v-model="formData.purchCompanyAddress" :readonly="true" maxlength="250" show-word-limit type="textarea" :rows="1"></el-input>
                    </el-form-item>
                ...
                <el-col :span="9">
                    ...
                    <el-form-item class="comright" label="电话">
                        <el-input v-model="formData.purchCompanyPhone" :readonly="true"></el-input>
                    </el-form-item>
            ...
            <el-row type="flex" class="row-bg " justify="space-around">
                <el-col :span="9">
                    ...
                    <el-form-item class="comright" label="地址">
                        <el-input :readonly="true" v-model="formData.residence" maxlength="250" show-word-limit type="textarea" :rows="1"></el-input>
                    </el-form-item>
                    <el-form-item class="comright" label="开户行">
                ...
                <el-col :span="9">
                    ...
                    <el-form-item class="comright" label="电话">
                        <el-input :readonly="true" v-model="formData.contactPhone"></el-input>
                    </el-form-item>
                    <el-form-item class="comright" label="帐号">
                        <el-input v-if="formData.accountType == 1" v-model="formData.privateAccountNumber" :readonly="true"></el-input>
                        <el-input v-else v-model="formData.publicAccountNumber1" :readonly="true"></el-input>
                    ...
                    <el-form-item class="comright" label="行业类型" :required="true">
                        <el-tooltip class="item" effect="dark" :content="selectTipType" placement="top-start">
                            <el-select class="main-select-tree" ref="selectTree" v-model="formData.industryType"
                                ...
                                <el-option v-for="item in formatData(industryTypes)" :key="item.value"
                                    :label="item.label" :value="item.value" style="display: none;" />
                                <el-tree class="main-select-el-tree" ref="selecteltree" :data="industryTypes"
                                    node-key="id" highlight-current :props="defaultProps" @node-click="handleNodeClick"
                                    :current-node-key="formData.industryType" :expand-on-click-node="expandOnClickNode">
                                    <span class="custom-tree-node" slot-scope="{ node, data  }" style="width:100%">
                                        <span style="float: left">{{ node.label }}</span>
                                        <span
                                            style="float: right; color: #8492a6; font-size: 14px;padding-right:10px">{{
                                                    data.taxRates
                                            }}</span>
                                    </span>
                                </el-tree>
            ...
            <el-row type="flex" class="row-bg " justify="space-around">
                ...
                <el-col :span="9">
                    ...
                    <el-form-item v-else class="comright" label="发票税率" :required="true">
            ...
            <el-row type="flex" class="row-bg " justify="space-around">
                <el-col :span="9">
                    <el-form-item class="comright" label="开票内容附件" v-if="fileNameradio == 2" :required="true">
                        <uploadSmall @getfileName="getfileNameS" :fileName="formData.fileName" :fileNameOld="fileName"
            ...
            <el-row type="flex" class="row-bg " justify="space-around">
                <el-col :span="21">
                    <el-form-item style="padding-right:4%" label="发票备注" prop="ticketRemark">
                        <el-input maxlength="50" show-word-limit :readonly="true" type="textarea" :rows="2"
                            placeholder="请输入发票备注" v-model="formData.projectDesc">
                        </el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row type="flex" class="row-bg" justify="space-around">
                <el-col :span="9">
                    <el-form-item label="结算方式" :required="true">
                        ...
                        <el-radio disabled v-model="formData.isSelfCount" label="2">按项目结算</el-radio>
                    </el-form-item>
                </el-col>
                <el-col :span="9">
            ...
            <el-row v-if="formData.isSelfCount == 0" type="flex" class="row-bg " justify="space-around">
                <el-col :span="9">
                    ...
                    <el-form-item v-if="formData.isRegisterMoney==0" label="个体户注册服务费" prop="registerMoney">
                        <el-input disabled v-model="formData.registerMoney" :min="0"
            ...
            <el-row v-if="formData.isSelfCount == 0 && formData.isSelfShare == 0" type="flex" class="row-bg "
                ...
                <el-col :span="9">
                    <el-form-item label="分润方式" prop="selfShare">
                        <div style="">
                            <el-radio disabled v-model="formData.selfShareIsmoney" label="0">按定额收取
                            </el-radio>
                            <el-radio disabled v-model="formData.selfShareIsmoney" label="1">按百分比收取
                            </el-radio>

                            <el-input disabled v-if="formData.selfShareIsmoney == 0" style="width:100%" :min="0"
                                v-model="formData.selfShare" onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                                <template slot="append">元</template>
                            </el-input>
                            <el-input disabled v-model="formData.selfShare" v-else style="width:100%" @input="isSelfShares"
                                :step="0.01" :min="0" :max="100" onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                  ...
                  <el-option v-for="item in optiond" :key="item.value" :label="item.label" :value="item.value">
                        ...
                        <el-form-item label="普票服务费" prop="ordinarySelfFee">
                            <div style="">
                                ...
                                <el-radio disabled v-model="formData.ordinaryProxyIsmoney" label="0">按定额收取
                                </el-radio>
                                <el-radio disabled v-model="formData.ordinaryProxyIsmoney" label="1">按百分比收取
                                </el-radio>
                                <el-input disabled v-if="formData.ordinaryProxyIsmoney == 0" v-model="formData.ordinarySelfFee"
                                    style="margin-right:10px" :min="0"
                                    onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                    oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                                    <template slot="append">元</template>
                                </el-input>
                                <el-input disabled v-else v-model="formData.ordinarySelfFee" style="margin-right:10px" :min="0"
                                    :max="100" onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                    oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                                    <template slot="append">%</template>
                                </el-input>
                            </div>
                        ...
                        <el-form-item label="服务费含税" :required="true">
                            <el-radio disabled v-model="formData.isSelfTax" label='0'>是</el-radio>
                            <el-radio disabled v-model="formData.isSelfTax" label='1'>否</el-radio>
                        </el-form-item>
                        <el-form-item label="价税分离" :required="true">
                            <el-radio disabled v-model="formData.isOrdinaryTax" label='0'>是</el-radio>
                            <el-radio disabled v-model="formData.isOrdinaryTax" label='1'>否</el-radio>
                        </el-form-item>
                        <el-form-item label="是否分润" :required="true">
                            <el-radio disabled v-model="formData.isOrdinaryShare" label="0">是</el-radio>
                            <el-radio disabled v-model="formData.isOrdinaryShare" label="1">否</el-radio>
                        </el-form-item>
                        <el-form-item v-if="formData.isOrdinaryShare == 0" label="分润方式" prop="ordinaryShare">
                            <div style="">

                                <el-radio disabled v-model="formData.ordinaryShareIsmoney" label="0">按定额收取
                                </el-radio>
                                <el-radio disabled v-model="formData.ordinaryShareIsmoney" label="1">按百分比收取
                                </el-radio>
                                <el-input 
                                disabled
                                v-if="formData.ordinaryShareIsmoney == 0" v-model="formData.ordinaryShare"
                                ...
                                <el-input v-else
                                disabled
                                v-model="formData.ordinaryShare" style="margin-right:10px;width:100%"
                                    :min="0" :max="100" onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                    oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                                    <template slot="append">%</template>
                                </el-input>
                            </div>
                ...
                <el-col :span="9">
                  ...
                  <el-option v-for="item in optionz" :key="item.value" :label="item.label" :value="item.value">
                        ...
                        <el-form-item label="专票服务费" prop="specialSelfFee">
                            <div style="">
                                <el-radio disabled v-model="formData.specialProxyIsmoney" label="0">按定额收取
                                </el-radio>
                                <el-radio disabled v-model="formData.specialProxyIsmoney" label="1">按百分比收取
                                </el-radio>
                                <el-input disabled v-if="formData.specialProxyIsmoney == 0" v-model="formData.specialSelfFee"
                                    style="margin-right:10px;width:100%" :min="0"
                                    onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                    oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                                    <template slot="append">元</template>
                                </el-input>
                                <el-input disabled v-else v-model="formData.specialSelfFee" style="margin-right:10px;width:100%"
                                    :min="0" :max='100' onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                    oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                                    <template slot="append">%</template>
                                </el-input>
                        ...
                        <el-form-item label="服务费含税" :required="true">
                            <el-radio disabled v-model="formData.isSpecialSelfTax" label='0'>是</el-radio>
                            <el-radio disabled v-model="formData.isSpecialSelfTax" label='1'>否</el-radio>
                        </el-form-item>
                        <el-form-item label="价税分离" :required="true">
                            <el-radio disabled v-model="formData.isSpecialTax" label='0'>是</el-radio>
                            <el-radio disabled  v-model="formData.isSpecialTax" label='1'>否</el-radio>
                        </el-form-item>
                        <el-form-item label="是否分润" :required="true">
                            <el-radio disabled v-model="formData.isSpecialShare" label="0">是</el-radio>
                            <el-radio disabled v-model="formData.isSpecialShare" label="1">否</el-radio>
                        </el-form-item>
                        <el-form-item v-if="formData.isSpecialShare == 0" label="分润方式" prop="specialShare">
                            <div style="">

                                <el-radio disabled v-model="formData.specialShareIsmoney" label="0">按定额收取
                                </el-radio>
                                <el-radio disabled v-model="formData.specialShareIsmoney" label="1">按百分比收取
                                </el-radio>
                                <el-input disabled v-if="formData.specialShareIsmoney == 0" 
                                    v-model="formData.specialShare" style="margin-right:10px;width:100%" :min="0"
                                    onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                    oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                                    <template slot="append">元</template>
                                </el-input>
                                <el-input disabled v-model="formData.specialShare" v-else style="margin-right:10px;width:100%"
                                    :min="0" :max="100" onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                                    oninput='value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'>
                                    <template slot="append">%</template>
                                </el-input>
