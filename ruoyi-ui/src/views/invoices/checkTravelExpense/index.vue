    ...
    <div class="app-container">      
        <el-form 
          ...
          <el-row  type="flex" justify="center">
            <el-col :span="6">
                ...
                <el-col :span="6">
                 <el-form-item class="comright" label="报销单号">
        ...
        <el-col :span="8">
          ...
          <el-form-item label="合计金额">
            ...
            <div v-hasPermi="['invoices:expense:upload']" label="付款凭证影像：" >
            ...
            <div  style="width:100%;display: flex;margin-bottom: 20px;"><div style="width:50%">报销凭证影像</div><div style="width:50%;text-align: right;">报销单号:{{ruleForm.travelExpenseCode}}</div></div>
...
<script>
    ...
    mounted: function() {
        ...
        this.ruleForm.roles=JSON.parse(window.localStorage.getItem('travelExpenseRoles'));
