    ...
    <div class="app-container">
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="200px" >
            <el-form-item id="title" >
                <span style="font-size:30px">借支单新增（管理员）</span>
            </el-form-item>
            ...
            <el-form-item label="借款开户行"   class="right2">
             ...
             <el-row type="flex" justify="space-around" >
                <el-col :span="9">
                    ...
                    <uploadInvoices v-if="imgArr.length >=0" :fileName="isNone" :fileNameOld="isNone"
...
<script>
    ...
    import {getCardInfoBycompany,getBankNameBycardId,getDepts} from '@/api/invoices/expense'
