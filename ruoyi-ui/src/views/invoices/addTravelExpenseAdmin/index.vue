      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          let params = {
            ...
            //总费用
            totalAllMoney:
              this.ruleForm.traffic1 +
              this.ruleForm.stay1 +
              this.ruleForm.subsidy1 +
              this.ruleForm.other1 +
              this.ruleForm.traffic2 +
              this.ruleForm.stay2 +
              this.ruleForm.subsidy2 +
              this.ruleForm.other2 +
              this.ruleForm.traffic3 +
              this.ruleForm.stay3 +
              this.ruleForm.subsidy3 +
              this.ruleForm.other3,
          };
          let params2 = {
