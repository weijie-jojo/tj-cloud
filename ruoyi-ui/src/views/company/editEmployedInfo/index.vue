  ...
  <div>
    <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="auto" label-position="right">
        ...
        <!-- <el-row type="flex" class="row-bg " justify="space-around">
          <el-col :span="9">
            <el-form-item label="客户全名" prop="placeName">
              <el-select @change="placenew" style="width:100%" v-model="formData.placeName" placeholder="请选择客户全名"
      ...
      <div v-show="actives == 4">
        <el-row type="flex" class="row-bg  combottom" style="margin-bottom:10px" justify="space-around">
          <el-col :span="9">
          ...
          <el-col :span="9">
            <el-form-item label="客户全名" prop="placeName">
              <el-select 
               ...
               @change="placenew"
              style="width:100%" v-model="formData.placeCode" placeholder="请选择客户全名" clearable filterable>
                <el-option v-for="(item, index) in places" :key="index" :label="item.placeAliasName" :value="item.placeCode">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
           ...
           <el-col :span="9">
                 <el-form-item label="分润方式" prop="selfShare">
                  <div style="">
                    ...
                    <el-input v-if="formData.selfShareIsmoney == 0" style="width:100%" 
                    ...
                    <el-input v-model="formData.selfShare" v-else style="width:100%"
            ...
            <div v-if="formData.isSliderOrdinary==0">
              ...
              <el-form-item  label="普票服务费" prop="ordinarySelfFee">
                <div style="">
                  ...
                  <el-input v-if="formData.ordinaryProxyIsmoney == 0" 
                    v-model="formData.ordinarySelfFee" style="margin-right:10px"  :min="0"
                     onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                    oninput = 'value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'
                    >
                    <template slot="append">元</template>
                  </el-input>
                  <el-input v-else   v-model="formData.ordinarySelfFee"
            ...
            <el-form-item label="是否分润" :required="true">
              ...
              <el-form-item v-if="formData.isOrdinaryShare==0"  label="分润方式" prop="ordinaryShare">
                <div style="">
                  ...
                  <el-input v-if="formData.ordinaryShareIsmoney == 0"  
        ...
        <el-col :span="9">
            ...
            <el-form-item label="专票服务费" prop="specialSelfFee">
              <div style="">
                ...
                <el-input v-if="formData.specialProxyIsmoney == 0"  
            ...
            <el-form-item v-if="formData.isSpecialShare==0" label="分润方式" prop="specialShare">
              <div style="">
                ...
                <el-input v-if="formData.specialShareIsmoney == 0" 
                ...
                <el-input 
                 ...
                 v-model="formData.specialShare" v-else  
                  style="margin-right:10px;width:100%"  :min="0" :max="100"
                   onkeyup="value=value.replace(/[^\x00-\xff]/g, '')"
                  oninput = 'value = (value.match(/^[0-9]+(\.[0-9]{0,2})?/g) ?? [""])[0]'
                  >
      ...
      for (let i in this.places) {
        if (this.places[i].placeCode == this.formData.placeCode) {
          ...
          crudPlace.selectFeeByCode({ placeCode: this.places[i].placeCode }).then(res => {
            ...
            this.formData.disposableFeeIsmoney=JSON.stringify(this.unlist.disposableFeeIsmoney);
            ...
            this.formData.isRegisterMoney=JSON.stringify(this.unlist.isRegisterMoney);
