      ...
      <el-table-column label="业务经理" align="center" prop="username" :show-overflow-tooltip="true" />
       <el-table-column label="办理状态" align="center" prop="">
         <template slot-scope="scope">
           <el-link :underline="false" type="primary"   v-if=" scope.row.taxStatus == 0">待办理</el-link>
           <el-link :underline="false"  type="success"  v-if=" scope.row.taxStatus == 1">已完成</el-link>
         </template>
       </el-table-column>
