<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="employedList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客户全名" width="350" align="center" prop="placeAliasName" :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button size="mini" v-hasPermi="['company:info:examine']" v-if="scope.row.infoStatus == 0" type="text" icon="el-icon-s-check"
            @click="bank(scope.row)">审核信息</el-button>
          <el-button size="mini" v-hasPermi="['company:info:examine']" v-else icon="el-icon-s-check"
