...
import crudReview from "@/api/tc-api/company/review";
  ...
  data() {
    return {
      ...
      formData: {
        ...
        specialShareMoney: null,
        specialShare: null,
        ordinaryShare: null,
        ordinaryShareMoney: null,
        ordinarySpecialTax: null,
        ordinaryTax: null,
        userId: "",
        titleType: "区县名",
      ...
      crudPerson.addPerson(parms3).then((res) => {
        if (res != undefined) {
          ...
          crudEmployed.check(parms).then((res) => {
            ...
            if (res != undefined) {
              if (res.code === 200) {
                this.$tab.closeOpenPage({ path: "/tc-business/reg/regSuccess" });
              } else {
                this.$message({
                  message: res.msg,
                  type: "danger",
