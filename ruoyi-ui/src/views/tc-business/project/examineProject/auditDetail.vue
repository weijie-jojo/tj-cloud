<template>
      ...
      >
        ...
        >
          <el-col :span="9" class="flexs">
            <div class="bankno" style="width: 45%">项目信息</div>
        ...
        >
          <el-col :span="9" class="flexs">
            <div class="bankno" style="width: 45%">票据信息</div>
            <div style="width: 50%; hegiht: 10px"></div>
          </el-col>
          <el-col :span="9">
            <div></div>
        ...
        >
          <el-col :span="9" class="flexs">
            <div class="bankno" style="width: 45%">结算信息</div>
            <div style="width: 50%; hegiht: 10px"></div>
          </el-col>
          <el-col :span="9">
            <div></div>
          ...
          <el-col :span="21">
            ...
            >
              <div
                ...
                "
              >
                <el-radio disabled v-model="CheckStatus" label="2"
                  >不通过
                </el-radio>
                <el-input
                  type="textarea"
  ...
  import { getcode, detail } from "@/api/tc-api/project/list";
