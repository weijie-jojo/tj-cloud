    ...
    <div>
        <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="140px">
            ...
            <el-row type="flex" class="row-bg " justify="space-around">
                ...
                <el-col :span="9">
                    <el-form-item class="comright" label="购货单位（甲方）纳税人识别号" :required="true">
            ...
            <el-row type="flex" class="row-bg " justify="space-around">
                ...
                <el-col :span="9">
                    ...
                    <el-form-item class="comright" label="销货单位（乙方）纳税人识别号" :required="true">
                    ...
                    <el-form-item class="comright" label="发票金额" prop="ticketAmount">
                        <el-input disabled type="number" style="width:100%" v-model="formData.ticketAmount" :step="0.01"
                        ...
                        if (res != undefined) {
                            if (res.code === 200) {
                                this.$nextTick(function () {
                                    ...
                                    this.$tab.closeOpenPage({ path: "/tc-business/project/ticketList" }).then(() => {
                                        this.$tab.refreshPage({ path: '/tc-business/project/ticketList', name: 'TicketList' });
                                    });
