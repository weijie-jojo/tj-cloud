...
import { list2, add } from "@/api/tc-api/project/ticket";
import { detail, getcode, getinfoByUserId, ownlist,edit,check} from "@/api/tc-api/project/list";
...
export default {
    ...
    data() {
        return {
            ...
            Father: [],
            formData: {
                projectCode:this.$cache.local.getJSON("tc-project-code"),//项目编号
                ticketRemark: '',//发票备注
                ticketTax: 3,//发票税率
                ticketType: 0,  //发票类型
                ticketCode: '',//发票种类编号
