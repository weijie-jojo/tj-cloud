...
export default {
  ...
  methods: {
              ...
              .then(() => {
                if (this.msgs == "查看") {
                 ...
                 let obj = {
                  ...
                  this.$tab.openPage(
                    "收款列表",
                    "/tj-business/project/aduitCollectList"
                  );
    ...
    addList() {
      ...
      switch (this.types) {
        case 2:
          ...
          break;
        case 4:
          this.$tab.closeOpenPage({ path: "/tj-business/project/addMeans" });
          break;
        case 5:
    ...
    aduit() {
      ...
      switch (this.types) {
        case 1:
          ...
          break;
        case 4:
          this.$tab.closeOpenPage({ path: "/tj-business/project/aduitMeans" });
          break;
        case 5:
    ...
    findList() {
      ...
      this.$cache.local.setJSON('tj-backMean',obj);
      this.$cache.local.setJSON("tj-backTicket", obj);
      ...
      switch (this.types) {
        case 1:
          ...
          break;
        case 2:
          this.$tab.openPage("票据列表查看", "/tj-business/project/ticketlist");
          break;
        case 4:
          this.$tab.openPage("资料审核查看", "/tj-business/project/auditMeansDetail");
          break;
        case 5:
          this.$tab.openPage(
            "完税审核查看",
            "/tj-business/project/aduitDutypaidDetail"
          );
          break;
        case 6:
          this.$tab.openPage("出款列表查看", "/tj-business/project/aduitCollectList");
          break;
        case 7:
          this.$tab.openPage("收款列表查看", "/tj-business/project/aduitDisburseList");
          break;
      }
    },
    //获取对应日志分页数据
    ...
    /** 新增按钮操作 */
    handleAdd() {
      this.$tab.openPage("项目新增", "/tj-business/project/add");
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
