                ...
                <el-col :span="9">
                    <el-form-item class="comright" label="缴税凭证">
                        ...
                        <div  v-if="formData.isUpRate==0">
                            <uploadSmall @getfileName="getPayTax" :fileName="fileName4" :fileNameOld="fileName4"
                ...
                <el-col :span="9">
                    <el-form-item class="comright" label="完税凭证">
                        ...
                        <div v-if="formData.isUpDutypaid==0">
                            <uploadSmall  @getfileName="getDuty" :fileName="fileName3" :fileNameOld="fileName3"
                            :isDetail="isDetail"></uploadSmall>
                        </div>
...
export default {
    ...
    methods: {
       ...
       //返回
       resetForm(){
         this.$tab.closeOpenPage({path:this.$cache.local.getJSON('tj-addback').backurl})
       },
       handleChange(val) {
            console.log(val);
        },
                         ...
                         if (res != undefined) {
                                if (res.code === 200) {
                                   this.$nextTick(function () {
                                     ...
                                     this.$tab.closeOpenPage({ path:this.$cache.local.getJSON('tj-addback').backurl }).then(()=>{
                                        this.$tab.refreshPage({path:this.$cache.local.getJSON('tj-addback').backurl,name:this.$cache.local.getJSON('tj-addback').name});
                                     })
