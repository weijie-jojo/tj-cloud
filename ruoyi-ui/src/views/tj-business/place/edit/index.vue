...
export default {
 ...
 mounted() {
      let item=this.$cache.local.getJSON("tj-placeItem");
      let  res=this.$cache.local.getJSON("tj-placeItems");
  ...
  methods: {
    ...
    backAgo(){
        this.$tab.closeOpenPage({path:'/tj-business/place/placelist'}).then(() => {
           this.$tab.refreshPage({path:'/tj-business/place/placelist',name:'Placelist'});
