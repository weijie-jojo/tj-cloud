...
export default {
  ...
  created() {
    let list = this.$cache.local.getJSON("tj-banklist");
    this.formBank = list;
    ...
    this.fileNameN1 = [];
    this.fileNameN2 = [];
    this.fileName3 = JSON.parse(this.$cache.local.getJSON('tj-banklist').fileName3);
    ...
    this.fileName4 = JSON.parse(this.$cache.local.getJSON('tj-banklist').fileName4);
