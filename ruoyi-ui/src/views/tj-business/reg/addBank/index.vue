        ...
        >
          <el-col :span="9">
            <el-form-item
              ...
              :required="true"
            >
              <el-radio v-model="formBank.isPublicUser" label="0"
                >开启</el-radio
              >
              <el-radio v-model="formBank.isPublicUser" label="1"
                >关闭</el-radio
              >
            </el-form-item>
          </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        selfName: [{ required: true, message: "请输入名称", trigger: "blur" }],
        legalPersonName: [
  ...
  mounted() {
    ...
    regDetail(this.$cache.local.getJSON("tj-banklist"))
      .then((res) => {
