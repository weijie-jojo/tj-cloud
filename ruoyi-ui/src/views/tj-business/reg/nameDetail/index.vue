      ...
      <el-row type="flex" class="row-bg" justify="space-around">
        <el-col :span="9">
          <el-form-item class="comright" label="字号">
            <el-checkbox disabled v-model="formData.random"
              >随机字号</el-checkbox
            >
          </el-form-item>
        </el-col>
        <el-col :span="9">
          <el-form-item class="comright" label="拟设名称">
            随机名称
          </el-form-item>
        </el-col>
      </el-row>
          ...
          >
            <div style="display: flex; align-items: center">
              ...
              <el-input
                ...
                type="textarea"
                v-model="this.formData.remarkName"
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      regDetail(this.$cache.local.getJSON("tj-namelist")).then((res) => {
