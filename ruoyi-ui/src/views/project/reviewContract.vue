        ...
        <el-table v-loading="loading" :data="projectList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" icon="el-icon-s-custom" @click="review(scope.row)">审核合同</el-button>
                  </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        //审核项目
        review(scope){
           this.$cache.local.setJSON("reviewContractDetail", scope);
            this.$router.push("reviewContractDetail");
        },
        detail(scope) {
