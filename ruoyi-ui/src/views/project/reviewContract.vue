        ...
        <el-table v-loading="loading" :data="projectList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                   <el-button size="mini" v-if="!scope.row.fileName1"  type="text" icon="el-icon-add" @click="details(scope.row)">合同办理</el-button>
                   <el-button size="mini" v-else type="text" icon="el-icon-s-custom" @click="detail(scope.row)">审核合同</el-button>
                </template>
            </el-table-column>
        </el-table>
