            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" v-else type="text" icon="el-icon-s-custom" @click="detail(scope.row)">审核验收
                      ...
                      <el-button size="mini" v-if="scope.row.projectAcceptanceStatus==1" type="text" icon="el-icon-s-custom" @click="find(scope.row,scope.row.projectCode)">查看验收</el-button>
                    <el-button size="mini" v-if="scope.row.projectAcceptanceStatus==2" type="text" icon="el-icon-s-custom" @click="edits(scope.row,scope.row.projectCode)">编辑验收
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
