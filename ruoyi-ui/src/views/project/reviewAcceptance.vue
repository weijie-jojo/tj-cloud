        ...
        <el-table v-loading="loading" :data="projectList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" icon="el-icon-s-custom" @click="review(scope.row)">审核验收</el-button>
                  </template>
            </el-table-column>
        </el-table>
...
export default {
    data() {
        return {
            ...
            queryParams: {
                ...
                projectAcceptanceStatus: 0, //项目状态
            },
            projectTime:[],
            pickerOptions: {
                shortcuts: [{
    ...
    methods: {
        ...
        //审核项目
        review(scope){
           this.$cache.local.setJSON("reviewAcceptanceDetail", scope);
            this.$router.push("reviewAcceptanceDetail");
        },
        detail(scope) {
