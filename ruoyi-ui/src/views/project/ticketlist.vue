<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button v-if="balance > 0" type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd">新增
                </el-button>
            </el-col>
            <el-col :span="1.5">
...
export default {
    ...
    methods: {
        ...
        //计算已开和剩余金额
        ticketByCode() {
            //  list({  projectCode: this.publicList.projectCode }).then(res => {
            //     let arr = res.data;
        ...
        handleDelete() {
            ...
            //     placeCodeStr.push(item.ticketId);
            //   })
            //   let params = {
            //     ticketIds: placeCodeStr.join(',')//转换成字符串
            //   };
            ...
            // const ticketIds = row.ticketId;
            // this.$modal
            //     .confirm('是否确认删除id为"' + ticketIds + '"的数据项？')
            //     .then(function () {
