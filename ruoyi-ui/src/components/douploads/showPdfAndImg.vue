<template>
  ...
  <div  class="demo-image__preview" v-for="(item, index) in fileNameOlds" :key="index">              
      <el-form-item label="报销凭证影像" v-if="item.suffix=='pdf'">
         <!-- <div class="tools flexs">
          ...
          <pdf ref="pdf" :src="item.url" :page="pageNum" :rotate="pageRotate" @progress="loadedRatio = $event"
            @page-loaded="pageLoaded($event)" @num-pages="pageTotalNum = $event" @error="pdfError($event)"
            @link-clicked="page = $event">
          </pdf> -->
          <el-image :src="baseImgPath + '20220804105302a66ef1-6104-4828-a7a1-f1944f85276120201128024046.png'"></el-image>
      </el-form-item>
      <el-form-item label="报销凭证影像" v-else>
