...
import com.ruoyi.project.mapper.SelfReceiveTgMapper;
 ...
 */
@Service
public class SelfReceiveTgServiceImpl implements ISelfReceiveTgService
{
    @Autowired
    private SelfReceiveTgMapper selfReceiveMapper;
