...
import com.ruoyi.project.mapper.ProjectCheckTgMapper;
 ...
 */
@Service
public class ProjectCheckTgServiceImpl implements IProjectCheckTgService
{
    @Autowired
    private ProjectCheckTgMapper projectCheckMapper;
