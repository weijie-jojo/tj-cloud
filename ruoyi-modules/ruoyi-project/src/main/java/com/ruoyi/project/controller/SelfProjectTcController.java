...
@RestController
@Api(tags = "项目管理（腾创）")
@RequestMapping("/project/tc")
public class SelfProjectTcController extends BaseController
{
    @Autowired
    private ISelfTicketTcService selfTicketService;
    @Autowired
    private ISelfProjectTcService selfProjectService;
    @Autowired
