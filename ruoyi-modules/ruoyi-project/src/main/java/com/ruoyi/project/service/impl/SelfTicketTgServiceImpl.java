...
import com.ruoyi.project.mapper.SelfTicketTgMapper;
 ...
 */
@Service
public class SelfTicketTgServiceImpl implements ISelfTicketTgService
{
    @Autowired
    private SelfTicketTgMapper selfTicketMapper;
