...
import com.ruoyi.project.mapper.SelfProjectTgMapper;
 ...
 */
@Service
public class SelfProjectTgServiceImpl implements ISelfProjectTgService
{
    @Autowired
    private SelfProjectTgMapper selfProjectMapper;
