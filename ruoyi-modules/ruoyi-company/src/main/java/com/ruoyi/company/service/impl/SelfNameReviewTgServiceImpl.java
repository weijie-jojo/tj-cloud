...
import com.ruoyi.company.mapper.SelfNameReviewTgMapper;
 ...
 */
@Service
public class SelfNameReviewTgServiceImpl implements ISelfNameReviewTgService
{
    @Autowired
    private SelfNameReviewTgMapper selfNameReviewMapper;
