...
import com.ruoyi.company.mapper.SelfLegalPersonMapper;
 ...
 */
@Service
public class SelfLegalPersonServiceImpl implements ISelfLegalPersonService 
{
    @Autowired
    private SelfLegalPersonMapper selfLegalPersonMapper;
