...
public interface SysBankcardMapper extends MPJBaseMapper<SysBankcard> {
    @Select("SELECT t.bankcard_id, t.bankcard_code, t.bank_id,t.user_id,B.bank_name FROM sys_bankcard t INNER JOIN sys_bank B ON t.bank_id=B.id WHERE t.bankcard_id = #{id}")
